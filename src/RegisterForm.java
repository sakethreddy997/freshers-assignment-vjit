...
public class RegisterForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Rubicon Register");
    ...
    private void jButton_Register_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_Register_ActionPerformed
        ...
        String mobile = jTextField_FN.getText();
        String email = jTextField_LN.getText();
        ...
        else if(checkUsername(uname))
        {
            ...
            String query = "INSERT INTO `the_app_users`(`u_mobile`, `u_email`, `u_uname`, `u_pass`) VALUES (?,?,?,?)";
